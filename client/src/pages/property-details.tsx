      ...
      <Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row'}} gap={4}>
        <Box>
          ...
          <Box mt='15px'>
            ...
            <Stack direction='row' justifyContent='space-between' flexWrap='wrap' alignItems='center'>
              <Box>
                <Typography fontSize={22} fontWeight={500} color='#11142d' textTransform='capitalize'>{propertyDetails.title}</Typography>
        ...
        <Box width='100%' flex={1} maxWidth={626} display='flex' flexDirection='column' gap='20px'>
          <Stack width='100%' p={2} direction='column' justifyContent='center' border='1px solid #E4E4E4' borderRadius={2}>
          ...
          <Stack>
              <img
                  src="https://www.google.com/maps/vt/data=dEWviWcXMM79OeXLSAjhzW4MPpjQBkQ5QXJocrWryvcKmi-chgka3_-R7Y3MolkOxTX-28bJuPu5asvMh6ixIiPXdw-CdijFx_tOGEQ5mleO9R-orfz2-gXcbInKcR3VmJqcHg-OMSA0Z8XVlvHBMcRG8io7QiO-KOYGFF656hRuq2UvKV1Med2zbDXHQGaB97wWwkkkhP6W6ZycvV3aZ_7GPOh6L4ZwlJvdZLOZsePxK9QeOPQ"
                  width="100%"
                  height={306}
